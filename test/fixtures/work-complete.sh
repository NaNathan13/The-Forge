...
# The session emitted the FORGEMASTER_COMPLETE sentinel in .result and exited 0 — the
# relaunch loop should break (exit 0), and launchd's SuccessfulExit=false keeps the
# loop from being respun.
CLAUDE_STUB_RESULT="all slices merged, nothing left FORGEMASTER_COMPLETE"

...
# The generation exited cleanly but .result contains neither FORGEMASTER_CONTINUE nor
# FORGEMASTER_COMPLETE. Per the design doc §1, the relaunch loop treats this as a fault

...
# The generation exited cleanly but .result contains neither OVERSEER_CONTINUE nor
# OVERSEER_COMPLETE. Per the design doc §1, the relaunch loop treats this as a fault

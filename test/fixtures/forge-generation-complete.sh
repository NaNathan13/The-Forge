...
# dispatches the seal subagent, relays seal's summary, and emits FORGE_COMPLETE
# as its final .result line. The relaunch loop should read FORGE_COMPLETE and
...
CLAUDE_STUB_RESULT="queue drained, seal subagent merged 3 PRs, MC reconciled FORGE_COMPLETE"

...
# The session wrote its continuation and exited with the FORGEMASTER_CONTINUE sentinel;
...
CLAUDE_STUB_RESULT="phase complete, continuation written FORGEMASTER_CONTINUE"

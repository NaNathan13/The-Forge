...
# The session wrote its continuation and exited with the OVERSEER_CONTINUE sentinel;
...
CLAUDE_STUB_RESULT="phase complete, continuation written OVERSEER_CONTINUE"

...
test_stdin_accepts_sentinel_line() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"success","issue":1,"pr":2,"branch":"b","tokens":null,"friction":null}'
  assert_exit_code 0 "$rc" "stdin sentinel line should validate"
}

test_stdin_accepts_bare_json_without_prefix() {
  # Forge sees the line with the `FORGE:RESULT ` prefix already stripped; the
...
test_accepts_absent_v_field_back_compat() {
  _run_validator_stdin 'FORGE:RESULT {"status":"success","issue":1,"pr":2,"branch":"b","tokens":null,"friction":null}'
...
test_rejects_v_field_unknown_version() {
  ...
  # been taught yet.
  _run_validator_stdin 'FORGE:RESULT {"v":2,"status":"success","issue":1,"pr":2,"branch":"b","tokens":null,"friction":null}'
...
test_rejects_malformed_json() {
  _run_validator_stdin 'FORGE:RESULT {not valid json}'
...
test_rejects_unescaped_quote_in_friction() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"needs_human","issue":1,"pr":2,"branch":"b","tokens":null,"friction":"he said "hi" oops","reason":"friction"}'
...
test_rejects_missing_friction_field() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"success","issue":1,"pr":2,"branch":"b","tokens":null}'
  assert_exit_code 1 "$rc" "missing friction field should be rejected"
}

test_rejects_continue_without_continuation_file() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"continue","issue":1,"pr":null,"branch":"b","tokens":null,"friction":null}'
  assert_exit_code 1 "$rc" "continue without continuation_file should be rejected"
}

test_rejects_needs_human_without_reason() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"needs_human","issue":1,"pr":2,"branch":"b","tokens":null,"friction":null}'
  assert_exit_code 1 "$rc" "needs_human without reason should be rejected"
}

test_rejects_fail_without_reason() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"fail","issue":1,"pr":null,"branch":"b","tokens":null,"friction":null}'
...
test_rejects_unknown_status() {
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"weird","issue":1,"pr":null,"branch":"b","tokens":null,"friction":null}'
...
test_rejects_multiline_input() {
  rc=0
  printf 'FORGE:RESULT {"v":1,"status":"success","issue":1,"pr":2,"branch":"b","tokens":null,"friction":null}\nextra line\n' \
    | "$VALIDATOR" >/dev/null 2>&1 || rc=$?
...
test_rejects_non_null_tokens() {
  ...
  _run_validator_stdin 'FORGE:RESULT {"v":1,"status":"success","issue":1,"pr":2,"branch":"b","tokens":1234,"friction":null}'
  assert_exit_code 1 "$rc" "non-null tokens should be rejected"
}

test_rejects_top_level_array() {
  _run_validator_stdin 'FORGE:RESULT [1,2,3]'

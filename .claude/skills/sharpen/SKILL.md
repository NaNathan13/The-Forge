...
- A pipeline skill (`/ponder`, `/forge`, `/foundry`, `/diagnose`, etc.)
...
- **Pipeline skills** (`/ponder`, `/forge`): Keep it to 1-3 sentences. The skill has its own structure — the prompt just seeds direction. Include the sub-phase ID.
